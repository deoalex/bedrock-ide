...
define("ace/mode/bedrock_highlight_rules",["require","exports","module","ace/lib/oop","ace/lib/lang","ace/mode/css_highlight_rules","ace/mode/javascript_highlight_rules","ace/mode/xml_highlight_rules"], function(require, exports, module) {
"use strict";
...
var bedrockHighlightRules = function() {
    ...
    this.addRules({
        ...
        bedrock_tag_contents : [
            {token : "comment.xml", regex : "<\\!--", next : "bedrock_comment"},
            {include : "tag_whitespace"},
            {include : "bedrock_string"},
        ...
        bedrock_func_attr : [{
            token : function(dot, name, paren) {
                if (paren === "")
                    return ["bedrock.operator", "bedrock_attribute"];
                return ["bedrock.operator", "bedrock_function", "paren.lparen"];
            },
            regex : /(\.)([a-zA-Z_$\x7f-\uffff][a-zA-Z0-9_\x7f-\uffff]*)(\(?)/
        }],
        bedrock_op : [{
        ...
        bedrock_other : [
            {
                token : "bedrock.constant.numeric", // hex
                regex : "0[xX][0-9a-fA-F]+\\b"
            }, {
                token : "bedrock.constant.numeric", // float
                regex : "[+-]?\\d+(?:(?:\\.\\d*)?(?:[eE][+-]?\\d+)?)?\\b"
            }, {
                token : "bedrock.operator",
                regex : /=|\+|\s\.\s|\-|\*|\//
            }, {
                token : "bedrock.paren.lparen",
                regex : "\\("
            }, {
                token : "bedrock.paren.rparen",
                regex : "\\)"
            }, {
                token : "text",
                regex : "\\s+"
    ...
    if (this.constructor === bedrockHighlightRules)
        this.normalizeRules();
};

oop.inherits(bedrockHighlightRules, XmlHighlightRules);
...
define("ace/mode/folding/bedrock",["require","exports","module","ace/lib/oop","ace/mode/folding/mixed","ace/mode/folding/xml","ace/mode/folding/cstyle"], function(require, exports, module) {
"use strict";
...
define("ace/mode/bedrock_completions",["require","exports","module","ace/token_iterator"], function(require, exports, module) {
"use strict";
...
(function() {
    ...
    this.getCompletions = function(state, session, pos, prefix) {
        ...
        var line = session.getLine(pos.row).substr(0, pos.column);
        if (/&[a-z]*$/i.test(line))
            return this.getbedrockEntityCompletions(state, session, pos, prefix);
    ...
    this.getbedrockEntityCompletions = function(state, session, pos, prefix) {
...
define("ace/mode/bedrock",["require","exports","module","ace/lib/oop","ace/lib/lang","ace/mode/text","ace/mode/javascript","ace/mode/css","ace/mode/bedrock_highlight_rules","ace/mode/behaviour/xml","ace/mode/folding/bedrock","ace/mode/bedrock_completions","ace/worker/worker_client"], function(require, exports, module) {
"use strict";
...
var Mode = function(options) {
    ...
    this.foldingRules = new bedrockFoldMode(this.voidElements, lang.arrayToMap(optionalEndTags));
};
oop.inherits(Mode, TextMode);
